    ...
    >
      ...
      <template #scroll-content>
        ...
        <div class="buttons main-content-wrapper">
          <SettingsButton
            @click.native="$router.push('/start/recovery')"
          >
            Change password
          </SettingsButton>
          <SettingsButton
            @click.native="$router.push('/settings/change-name')"
          >
            Change name
          </SettingsButton>
        </div>
        <div class="buttons main-content-wrapper">
          <LogoutButton
            @click.native="showModal.logout = true"
          />
        </div>
        <div class="buttons main-content-wrapper">
          <button class="delete-profile timemaster-subtitle"
