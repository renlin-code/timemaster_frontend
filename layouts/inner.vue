    ...
    <Transition name="fade">
      ...
      >
        <template #scroll-content>
          <CategoriesAccordion
            class="inner-task-modal__categories"
            v-if="!showTaskModal.fromCategory"
            @selectCategory="selectCategory"
          />

          <CalendarAccordion
            class="inner-task-modal__calendar"
            v-if="!showTaskModal.fromCalendar"
            @selectDate="selectDate"
          />

          <ImportantButton class="inner-task-modal__important" @select="setImportant" />
        </template>
