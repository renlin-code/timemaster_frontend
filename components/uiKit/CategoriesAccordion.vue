<template>
  <div class="categories-accordion">
    <div
      class="categories-accordion__accordion"
        ...
        >
          ...
          <div class="categories-accordion__sub-accordion-body">
            <div class="categories-accordion__sub-accordion-name">
              ...
              <span
                class="categories-accordion__error categories-accordion__sub-accordion-error"
                v-if="showErrorNew.name"
                :class="{
                  'categories-accordion__error--shake': animateErrorNameNew,
                }"
              >
            ...
            <div class="categories-accordion__sub-accordion-color">
              ...
              <span
                class="categories-accordion__error categories-accordion__sub-accordion-error"
                v-if="showErrorNew.color"
                :class="{
                  'categories-accordion__error--shake': animateErrorColorNew,
                }"
              >
    ...
    <span
      class="categories-accordion__error timemaster-caption"
      v-if="showError"
      :class="{ 'categories-accordion__error--shake': animateError }"
    >
      Select a category
    </span>
  </div>
...
export default {
  ...
  data: () => ({
    ...
    animateErrorNameNew: false,
    animateErrorColorNew: false,
  ...
  methods: {
    ...
    async submitNewCategory() {
      if (!this.newCategoryData.name) {
        this.showErrorNew.name = true;
        this.animateErrorNameNew = true;
      } else {
        this.showErrorNew.name = false;
      }
      if (!this.newCategoryData.color) {
        this.showErrorNew.color = true;
        this.animateErrorColorNew = true;
      } else {
        this.showErrorNew.color = false;
      }
  ...
  watch: {
    ...
    animateErrorNameNew(value) {
      if (value) {
        setTimeout(() => {
          this.animateErrorNameNew = false;
        }, 1300);
      }
    },
    animateErrorColorNew(value) {
      if (value) {
        setTimeout(() => {
          this.animateErrorColorNew = false;
        }, 1300);
      }
    },
    open(value) {
